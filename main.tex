...
\begin{document}
    ...
    \section{Leadership and Projects}
        ...
        \begin{twocolentry}
            ...
            {\textbf{Hybrid FFT/NTT Accelerator SoC} (28nm Tapeout) \\}
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}

                \item End-to-end design of a novel hybrid accelerator that supports both FFT and NTT operations through hardawre reuse
