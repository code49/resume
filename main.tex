...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{twocolentry}
            ...
            % \href{https://www.cmu.edu/}{\underline{Carnegie Mellon University (CMU)}} | Pittsburgh, PA
            \href{https://www.ece.cmu.edu/academics/ms-ece/index.html}{\underline{Carnegie Mellon University (CMU)}} | Pittsburgh, PA
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                % \item GPA: 3.73/4.00; \textit{4x College of Engineering Dean's List Recipient}
                % \item \textbf{Coursework:} Digital IC Tapeout, Digital Integrated Circuit Design (SRAM), Innovation Strategy and Management
                \item Digital Integrated Circuit Design (SRAMs), Innovation Strategy and Management
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item GPA: 3.8/4.0; \textit{5x College of Engineering Dean's List Recipient}
                % \item \textbf{Coursework:} Digital IC Tapeout, Computer Architecture, Digital Design Verification, Microelectronic Circuits, Machine Learning, Computer Systems, Signal Analysis, Linear Algebra, Multivariable Calculus, Statistics
                \item Digital IC Tapeout, Computer Architecture, Digital Design Verification, Microelectronic Circuits, Machine Learning, Computer Systems, Signal Analysis, Linear Algebra, Multivariable Calculus, Statistics
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Work Experience}
        ...
        \begin{twocolentry}
            ...
            % \href{https://www.ece.cmu.edu/}{IO Harness Project, CMU ECE} | Pittsburgh, PA
    ...
    \section{Leadership and Projects}
        ...
        \begin{twocolentry}
            ...
            % \textbf{Head Teaching Assistant, }\href{https://courses.ece.cmu.edu/18100}{\textbf{Introduction to ECE (18-100)}} \\
    ...
    \section{Skills}
        ...
        \begin{onecolentry}
            \begin{highlights}
                % \item \textbf{Hardware:} SystemVerilog, VCS/Questa, Quartus/Vivado, TCL, Cadence (Virtuoso/Genus/Innovus), KiCAD/Fusion360
                ...
                % \item \textbf{Software:} Python (NumPy, Pandas, Scikit), Git, Bash, C/C++, MATLAB
                % \item \textbf{Software:} Python (NumPy, Pandas, Scikit), Git, Bash scripts, C/C++, MATLAB, Rust, JavaScript, PHP, SQL
            \end{highlights}
        \end{onecolentry}
        ...
        % \begin{onecolentry}
        %     \textbf{Miscellaneous:} English (Native), Mandarin Chinese (Proficient), Git, LaTeX, Linux, MS Office
        % \end{onecolentry}
